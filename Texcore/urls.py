...
urlpatterns = [
    ...
    path('keycloak/login/', auth_views.keycloak_login, name='keycloak_login'),
    path('keycloak/callback/', auth_views.keycloak_callback, name='keycloak_callback'),
    ...
    path('kms-demo/', dashboard_views.send_encrypted_message, name='kms_demo'),
