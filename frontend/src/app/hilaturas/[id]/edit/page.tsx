  ...
  useEffect(() => {
    const fetchHilatura = async () => {
      try {
        ...
        setPreparacionOrigen(
          hilaturaData.preparacion_origen
            ? hilaturaData.preparacion_origen.toString()
            : "",
        );
  ...
  return (
    <div>
      <h1 className="text-3xl font-bold mb-6">
        Editar Proceso de Hilatura: {hilatura.id}
      </h1>
      ...
      >
        ...
        <div className="mb-4">
          ...
          >
            <option value="">
              Seleccione una preparación de origen (opcional)
            </option>
            {preparaciones.map((p) => (
        ...
        <div className="mb-4">
          ...
          <input
            ...
            value={torsion || ""}
            onChange={(e) =>
              setTorsion(e.target.value ? Number(e.target.value) : null)
            }
            disabled={submitting}
          />
        </div>
        ...
        <div className="mb-4">
          ...
          <input
            ...
            value={resistencia || ""}
            onChange={(e) =>
              setResistencia(e.target.value ? Number(e.target.value) : null)
            }
            disabled={submitting}
          />
        </div>
