...
const AuthProvider = ({ children })=>{
    ...
    const fetchUser = async ()=>{
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/auth/user/');
            setUser(data);
    ...
    const login = async (username_param, password_param)=>{
        ...
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/auth/csrf/'); // This will ensure CSRF cookie is set
    ...
    const logout = async ()=>{
        setIsLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/auth/logout/');
            setUser(null);
            setIsAuthenticated(false);
        } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e58c4a77._.js.map