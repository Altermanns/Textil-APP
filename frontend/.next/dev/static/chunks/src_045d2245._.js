...
const AuthProvider = ({ children })=>{
    ...
    const fetchUser = async ()=>{
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/auth/user/');
            setUser(data);
    ...
    const login = async (username_param, password_param)=>{
        setIsLoading(true);
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/auth/csrf/'); // This will ensure CSRF cookie is set
            ...
            setIsAuthenticated(false);
            throw error_0; // Re-throw to be handled by login page
        } finally{
            setIsLoading(false);
        }
    };
...
const useAuth = ()=>{
    ...
    if ($[0] !== "5287a28640de321159f73395f9c21642fada2e5e017627e824da9572bd68984b") {
        for(let $i = 0; $i < 1; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "5287a28640de321159f73395f9c21642fada2e5e017627e824da9572bd68984b";
    }
...
//# sourceMappingURL=src_045d2245._.js.map